-- Site Özellikleri alt menü öğesini ekle (Otel ana menüsü altına)
...
BEGIN
  ...
  -- Site Özellikleri alt menü öğesini ekle
  ...
  RAISE NOTICE 'Site Özellikleri menüsü başarıyla eklendi!';
END $$;
