-- Footer Yönetimi alt menü öğesini ekle (Otel ana menüsü altına)
...
BEGIN
  ...
  -- Footer Yönetimi alt menü öğesini ekle
  ...
  RAISE NOTICE 'Footer Yönetimi menüsü başarıyla eklendi!';
END $$;
