-- Önce eski yanlış kayıtları temizle
DELETE FROM ceviriler 
WHERE kategori = 'homepage' 
  AND anahtar LIKE 'homepage.%';

DELETE FROM ceviriler 
WHERE kategori = 'common' 
  AND anahtar LIKE 'common.%';

DELETE FROM ceviriler 
WHERE kategori = 'products' 
  AND anahtar LIKE 'products.%';

DELETE FROM ceviriler 
WHERE kategori = 'herosearch' 
  AND anahtar LIKE 'herosearch.%';

DELETE FROM ceviriler 
WHERE kategori = 'tabs' 
  AND anahtar LIKE 'tabs.%';

-- Şimdi doğru kayıtları ekle
